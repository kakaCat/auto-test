...
@router.get("/", response_model=dict, summary="获取系统列表")
...
@router.get("/{system_id}", response_model=dict, summary="获取系统详情")
...
@router.post("/", response_model=dict, summary="创建系统")
...
@router.put("/{system_id}", response_model=dict, summary="更新系统")
...
@router.delete("/{system_id}", response_model=dict, summary="删除系统")
