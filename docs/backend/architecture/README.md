...
### ⭐ **推荐：v4 极简架构**
- **文档**: [v4_simplified.md](./v4_simplified.md)
- **核心理念**: 极简控制器 + 防腐层架构
- **适用场景**: 
  - 🚀 快速开发和原型验证
  - 🤖 AI代码生成友好
...
### 📋 其他架构版本
- **v2 分层架构**: [v2.md](./v2.md) - 传统三层架构，适合标准CRUD
- **v3 DDD架构**: [v3_ddd.md](./v3_ddd.md) - 复杂领域驱动设计，适合大型企业项目

> **重要提示**: 新项目强烈推荐使用 **v4 极简架构**，除非有特殊的复杂业务需求。
